        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-700 dark:text-gray-300">
              Python Developer in AI
            </h2>
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0">
              Crafting intelligent solutions with Python and AI. Specialized in machine learning, deep learning, natural
              language processing, and computer vision using cutting-edge frameworks and techniques.
            </p>
            <SocialLinks className="justify-center lg:justify-start mb-8" />
            <motion.button
